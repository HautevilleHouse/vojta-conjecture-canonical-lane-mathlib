# Vojta Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/vojta-conjecture-canonical-lane-mathlib.git
cd vojta-conjecture-canonical-lane-mathlib
lake exe
lake build
```
